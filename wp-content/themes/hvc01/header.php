...
<meta name="google-site-verification" content="oTg9eTd1PXbsyS1QUCkHxLWqBY1L42uWm0YLhhbBRrY" />

<!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-136105276-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-136105276-2');
</script>
